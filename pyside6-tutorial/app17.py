...
from PySide6.QtWidgets import QCheckBox, QMainWindow, QApplication, QVBoxLayout, QLabel, QWidget
from PySide6.QtGui import QColor, QBrush, QPaintEvent, QPen, QPainter
import PySide6
from animated_toggle import AnimatedToggle


class AnimatedToggle0(QCheckBox):
    ...
    def __init__(self,
        ...
        super(AnimatedToggle0, self).__init__(parent)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        secondaryToggle = AnimatedToggle0(
